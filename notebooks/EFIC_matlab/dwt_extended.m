function [I_W , S, B] = dwt_extended(I, level, Lo_D, Hi_D)
% Matlab implementation of SPIHT (without Arithmatic coding stage)
%
% Wavelet decomposition
%
% input:    I : input image
%           lSevel : wavelet decomposition level
...
lam = level+1;
B(1:S(1,1) , 1:S(1,2)) = repmat(2^(lam+1),S(1,1:2));
lam = lam-1;
...
for k = 2 : L-1
    ...
    B( 1:S(k,1) , columns ) = repmat(2^(lam+1)+1, S(k,1:2));
